<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('uts_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/guru*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-crown c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('guru_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.gurus.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/gurus") || request()->is("admin/gurus/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-book c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.guru.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
